...
public enum ErrorCode {
    ...
    COMPLAINT_NOT_FOUND("Complaint[id=%s] lookup failed: current role=%s"),
    COMPLAINT_STATUS_INVALID("Complaint[status=%s] update failed: current role=%s"),
    COMPLAINT_CATEGORY_INVALID("Complaint[category=%s] create failed: current role=%s"),
